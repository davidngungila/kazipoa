...
class KaziliveClientEnhanced extends StatelessWidget {
  const KaziliveClientEnhanced({super.key});
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        GestureDetector(
          onTap: () {
            // Exit live session and return to kazi live hub
            context.go('/kazi_live_hub');
          },
          child: const Icon(Icons.arrow_back, color: Colors.cyan),
        ),
        const Text(
          "Job Room",
          style: TextStyle(
